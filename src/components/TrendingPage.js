    ...
    return (
        <div className="bg-white border-2 m-4 py-6 px-4 border-gray-900">
            ...
            <div className="float-right -ml-96 text-center mr-32 mt-8">
                <h3 className="text-2xl font-bold -ml-96">Women And Technology</h3>
                <h4 className="text-xl -ml-96">by The Authour</h4>
            </div>
            <br></br>
            <div className="flex">
                <img className=" h-full w-1/2 rounded-l-3xl border-4 border-blue-500 ml-8 -mr-8 shadow-2xl" src={women} alt="women in tech"/>
            ...
            <p className="ml-8 bg-blue-100 w-72 px-4 rounded-r-full border-2 border-gray-400 -mt-72 mb-6 ">OTHER STORIES ON TRENDING</p>
            <p className="ml-8 bg-blue-100 w-72 px-4 rounded-r-full border-2 border-gray-400 mb-6 ">OTHER STORIES ON TRENDING</p>
            <p className="ml-8 bg-blue-100 w-72 px-4 rounded-r-full border-2 border-gray-400 mb-6 ">OTHER STORIES ON TRENDING</p>
            <p className="ml-8 bg-blue-100 w-72 px-4 rounded-r-full border-2 border-gray-400 mb-20 ">OTHER STORIES ON TRENDING</p>
            <br></br>
