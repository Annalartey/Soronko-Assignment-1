...
function EntPage() {
    return (
        ...
        <h1 className="font-bold text-4xl text-center">Entertainment Filla</h1>
         <hr></hr>
         <br></br>
        <div className="float-right -ml-96 text-center mr-32 mt-4">
            <h3 className="text-2xl font-bold -ml-96">Does She Deserve The Crown? <br></br> Miss Malaika 2020</h3>
            <h4 className="text-xl -ml-96">by Anna Lartey</h4>
        </div>
        <br></br>
        <div className="flex">
            <img className=" h-full w-1/2 rounded-l-3xl border-4 border-blue-500 ml-8 -mr-8 shadow-2xl" src={crown} alt="women in tech"/>
        ...
        <p className="ml-8 bg-blue-100 w-72 px-4 rounded-r-full border-2 border-gray-400 mb-6 mt-10 ">OTHER BUSINESS STORIES</p>
        <br></br>
