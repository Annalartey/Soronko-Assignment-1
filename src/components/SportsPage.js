...
function SportsPage() {
    return (
        ...
        <h1 className="font-bold text-4xl text-center">Sports & Games</h1>
         <hr></hr>
         <br></br>
        <div className="float-right -ml-96 text-center mr-32 mt-8">
            <h3 className="text-2xl font-bold -ml-96">Covid Versus FIFA Worldcup.</h3>
            <h4 className="text-xl -ml-96">by Blessing Lartey</h4>
        </div>
        <br></br>
        <div className="flex">
            <img className=" h-full w-1/2 rounded-l-3xl border-4 border-blue-500 ml-8 -mr-8 shadow-2xl" src={stadium} alt="women in tech"/>
